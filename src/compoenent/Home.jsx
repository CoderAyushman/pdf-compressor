...
const Home = () => {
  return (
    ...
    <br/>
         <div className="about-compress">
         <div className="p1">
                <h2>Best Online PDF Compressor</h2>
                <p>Our Compress PDF tool was made for compressing large PDFs online for free. Whether you need to shrink files for easier emailing, sharing, or storage, you’ll be ready to go within seconds.
                </p>
            </div>
            <div className="im">
            ...
            <div className="p1">
                <h2>Easy Sharing Once You’re Done</h2>
